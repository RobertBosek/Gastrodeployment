...
NEED_COLOR_IMAGE_ADDITIONAL_FULL = False
    ...
    def loop(self):
        ...
        while True:
            ...
            color_image_table, left_ir_image_table, depth_image_table, foreground_mask, hsv_image_table, \
                color_image_additional_table = self.preprocess_camera_frames(color_image, depth_image, left_ir_image,
                                                                             color_image_additional)

            self.publish_camera_frames(color_image, color_image_table, left_ir_image, left_ir_image_table,
